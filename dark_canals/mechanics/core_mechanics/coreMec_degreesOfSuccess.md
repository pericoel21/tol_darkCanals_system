...
The Degrees of Success of a [[dark_canals/mechanics/core_mechanics/coreMec_rollResolution|Roll]] are determined by comparing the `Success Dice` to the requirements given by the [[dark_canals/mechanics/core_mechanics/coreMec_difficulty|Difficulty]].
...
> Use Degrees of Success when it really matters as to not slow down the game too much. Try to avoid them if a simple binary outcome is enough (success or fail).