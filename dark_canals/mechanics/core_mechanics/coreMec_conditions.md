...
Each Condition has an associated [[coreMec_attributes|Attribute]] which both defines the maximum amount of boxes in that Condition and gets affected by that Condition.

| Condition                         | Attribute                   |
| --------------------------------- | --------------------------- |
| [[cond_starvation\|Starvation]]   | [[attr_strength\|STRENGTH]] |
| [[cond_exposure\|Exposure]]       | [[attr_strength\|STRENGTH]] |
| [[cond_dehydration\|Dehydration]] | [[attr_agility\|AGILITY]]   |
| [[cond_exhaustion\|Exhaustion]]   | [[attr_wits\|WITS]]         |
| [[cond_burnout\|Burnout]]         | [[attr_empathy\|EMPATHY]]   |
