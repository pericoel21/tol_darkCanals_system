...
aliases:
  - Making Camp
connections:
  - "[[mechanic_watches#The Night Watch|The Night Watch]]"
description: A camp helps with recuperation and adverse weather
---
# `= this.file.aliases[0]`
> `= this.description`.

Having made a camp makes any [[mechanic_rollResolution|Rolls]] for [[condition_exposure|Exposure]] `EASIER`.

It takes one person one [[mechanic_watches|Watch]] to Make Camp.
