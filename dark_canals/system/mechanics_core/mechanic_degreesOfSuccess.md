...
The Degrees of Success of a [[mechanic_rollResolution|Roll]] are determined by comparing the `Success Dice` to the requirements given by the [[mechanic_difficulty|Difficulty]].
