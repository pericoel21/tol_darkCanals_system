...
| ------------------------------------------ | ------------------------------------------------------------------------------ |
| 1+                                         | [[combat_melee#Result of the Attack Roll\|Full hit]] (Arm / item held) |
| 0                                          | [[combat_melee#Result of the Attack Roll\|Heavy hit]] (Arm/item held)  |
...
- If the **[[item|Item]] rating** is **lower** than the **[[mechanic_injury|Injury rating]],** the item **gets [[damagedItem|Damaged]].**
- If an item gets **[[damagedItem|Damaged]] a second time,** it is **destroyed.**
- [[traits_rusty|Rusty]] items count as damaged.

### Item Rating
- *[[weapon|Weapons]]:* Equal to their [[mechanic_injury|Injury Rating]].
- *Can be used as [[traits_improvisedWeapon|Improvised Weapon]]:* Possibly **[[mechanic_injury|Serious Injury (1)]] rating.**
...
- [[mechanic_injury|Injury Rating]] is equal or higher than the [[item_shield|Shield's]] [[mechanic_armour|Armour Rating]].
