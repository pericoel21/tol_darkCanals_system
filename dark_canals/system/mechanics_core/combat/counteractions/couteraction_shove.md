...
**Moves an enemy one [[coreMec_combat_distance|Range Category]]** further away.

Using a [[item_shield|Shield]] and having [[proficiencies_shield|Shield Profficiency]] gives the [[coreMec_modifier|Modifier]] to the [[coreMec_rollResolution|Roll]].
