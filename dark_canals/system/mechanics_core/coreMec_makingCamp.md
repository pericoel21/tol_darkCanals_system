...
aliases:
  - Making Camp
connections:
  - "[[coreMec_watches#The Night Watch|The Night Watch]]"
description: A camp helps with recuperation and adverse weather
---
# `= this.file.aliases[0]`
> `= this.description`.

Having made a camp makes any [[coreMec_rollResolution|Rolls]] for [[cond_exposure|Exposure]] `EASIER`.

It takes one person one [[coreMec_watches|Watch]] to Make Camp.
