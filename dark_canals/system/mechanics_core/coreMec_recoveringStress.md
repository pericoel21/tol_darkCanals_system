...
aliases:
  ...
  - Recovering Stress
connections:
description: Stress might be recovered by relaxing at a safe place, or with the help of another character who appeals to you
---
# `= this.file.aliases[0]`
> `= this.description`.

## Recovery by Relaxation
For every hour a Character spends relaxing in a safe place, they decrease their [[stat_stress|Stress]] by one.
...
Once per [[coreMec_watches|Watch]], if another Character makes a successful [[skill_appeal|APPEAL]] roll, they can reduce the Character [[stat_stress|Stress]] Stress by one.

This cannot be performed on oneself.