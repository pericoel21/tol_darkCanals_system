...
- Spend a [[mechanic_watches|Watch]] looking for a seller.
- Roll [[skill_connections|CONNECTIONS]]. The difficulty depends on the size of the [[mechanic_settlements|Settlement]].

### Result of the Roll
#### Failing the Roll
There is no one in the current [[mechanic_settlements|Settlement]] who wants to sell, has the quantity, or likes the named price for any the Trade Goods.
- You can try in a different [[mechanic_settlements|Settlement]].
...
### Result of the roll
#### Failing the Roll
There is no one in the current [[mechanic_settlements|Settlement]] who wants to buy Artefact or the Trade Goods (or can afford to).
- You can try in a different [[mechanic_settlements|Settlement]].
- You can try again in the current [[mechanic_settlements|Settlement]] in one week’s time.

#### Succeeding the Roll
You may exchange the Artefact or the Trade Goods for one [[mechanic_coin|COIN]], doubling the [[mechanic_coin|COIN]] for each level of success higher than the Difficulty, to a maximun of four [[mechanic_coin|COIN]].
...
After refusing an offer, the PC might spend another [[mechanic_watches|Watch]] and roll again. Each time an offer is refused, the [[mechanic_difficulty|Difficulty]] is raised by one step for that Artefact or those Goods.

After one week, the [[mechanic_difficulty|Difficulty]] resets to the base.

### Exchanging the Artefact or the Goods
An Artefact or a unit of Trade Goods can always be exchange for something worth one [[mechanic_coin|COIN]] at a location where such trade could happen.
...
In the case of Trade Goods only, demand for a product in a given settlement can make the [[mechanic_difficulty|Difficulty]] for the selling [[mechanic_rollResolution|Roll]] `Easier`.